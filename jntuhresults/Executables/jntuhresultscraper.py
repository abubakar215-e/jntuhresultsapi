...
class ResultScraper:
    def __init__(self, roll_number):
        ...
        self.exam_codes={
                'btech': {
                    ...
                    '2-2': ['1437', '1447', '1476', '1501', '1565', '1605', '1627', '1663', '1711'],
        ...
        self.grades_to_gpa = {'O': 10, 'A+': 9, 'A': 8, 'B+': 7, 'B': 6, 'C': 5, 'D': 0, 'F': 0, 'P': 0, 'Ab': 0, '-': 0}
    ...
    def scrape_results(self, semester_code, response):
        ...
        subject_internal_index = Results_column_names.index("INTERNAL")
        subject_external_index = Results_column_names.index("EXTERNAL")
        subject_total_index = Results_column_names.index("TOTAL")        
        ...
        for result_subject in Results:
            ...
            subject_credits = result_subject.find_all("td")[subject_credits_index].get_text()
            subject_internal = result_subject.find_all("td")[subject_internal_index].get_text()
            subject_external = result_subject.find_all("td")[subject_external_index].get_text()
    ...
    async def scrape_all_results(self, exam_code="all"):
        async with aiohttp.ClientSession() as session:
            ...
            if exam_code != "all":
                # print({exam_code : exam_codes[exam_code]})
